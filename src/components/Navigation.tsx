...
function ProgressBar() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-200 opacity-20">
      <div 
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button 
              ...
              className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
            >
              제휴 신청
            </button>
          </div>
        ...
        {/* 모바일 메뉴 */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-md rounded-2xl shadow-xl mx-4 mb-4 overflow-hidden">
            <div className="py-4">
              ...
              {/* 모바일 CTA */}
              <div className="px-6 pt-4 border-t border-gray-200 mt-4">
                <button 
                  onClick={() => scrollToSection('partnership')}
